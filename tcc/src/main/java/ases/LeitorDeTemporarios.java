...
/**
 * Leitor de relat�rios
 *
 */
public class LeitorDeTemporarios {

	public LeitorDeTemporarios() {
	}

	public RelatorioDaUrl leiaTemporario(String path, ContextoDeAvaliacao contexto) {

		HashMap<String, Document> docs = LeitorDeRelatorio.lerRelatorios(contexto.getFolderTemp() + path);
